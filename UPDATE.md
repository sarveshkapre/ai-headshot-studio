...
- Added batch processing endpoint + UI panel (`POST /api/batch`) for multi-upload ZIP exports.
- Added local Profiles library plus preset bundle export/import for sharing multiple named setups.
